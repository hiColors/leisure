...
public enum HttpStatus {
     ...
     * {@link com.github.hicolors.leisure.common.exception.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link com.github.hicolors.leisure.common.exception.HttpStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link com.github.hicolors.leisure.common.exception.HttpStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link com.github.hicolors.leisure.common.exception.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     */
    ...
    /**
     * 增加一层内存缓存，避免 for 循环浪费性能
     */
    public static class Cache {
        private static ConcurrentHashMap<Integer, HttpStatus> httpStatusCache = new ConcurrentHashMap<>();

        public static HttpStatus get(Integer status) {
            return httpStatusCache.get(status);
        }

        public static void put(Integer status, HttpStatus httpStatus) {
            httpStatusCache.put(status, httpStatus);
        }
    }
